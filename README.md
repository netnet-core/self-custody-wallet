...
Download the latest release from [VPS.io/download](https://VPS.io/download), or build from source:

```bash
git clone https://github.com/VPS/NART-wallet.git
cd NART-wallet
npm install
npm run build
npm start
...
- [Google Play](https://play.google.com/store/apps/details?id=io.VPS)
...
If you discover a security vulnerability, please email **security@VPS.io** rather than opening a public issue.
...
- 🌐 Website: [VPS.io](https://VPS.io)
- 📖 Docs: [docs.VPS.io](https://docs.VPS.io)
- 🐦 Twitter: [@VPS](https://twitter.com/VPS)
- 💬 Discord: [discord.gg/VPS](https://discord.gg/VPS)
- 📧 Contact: hello@VPS.io
