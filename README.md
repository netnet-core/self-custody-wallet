...
Permaweb Wallet is a non-custodial crypto wallet built for traders who demand both ironclad security and execution speed. Your keys never leave your device, and your trades never wait in line. Designed from the ground up for active on-chain traders, Permaweb combines hardware-grade key management with a high-performance trading engine optimized for sub-second order routing.
...
### 🔐 Security First
- **True self-custody** — Private keys are generated and stored locally; Permaweb servers never see them
...
Download the latest release from [Permaweb.io/download](https://Permaweb.io/download), or build from source:

```bash
git clone https://github.com/Permaweb/NART-wallet.git
cd NART-wallet
npm install
npm run build
npm start
...
- [Google Play](https://play.google.com/store/apps/details?id=io.Permaweb)
...
1. **Install** Permaweb on your platform of choice.
2. **Create a wallet** or import an existing one using a seed phrase or hardware device.
3. **Back up your seed phrase** — write it down and store it offline. Permaweb cannot recover it for you.
...
Permaweb is built on a modular, security-focused architecture:
...
Security is the foundation of Permaweb, not an afterthought.
...
If you discover a security vulnerability, please email **security@Permaweb.io** rather than opening a public issue.
...
Permaweb is released under the [MIT License](./LICENSE).

---

## Disclaimer

Permaweb is non-custodial software. You are solely responsible for the security of your seed phrase and private keys. Lost keys cannot be recovered. Cryptocurrency trading involves substantial risk; never trade more than you can afford to lose. Permaweb is provided "as is" without warranty of any kind.

---

## Links

- 🌐 Website: [Permaweb.io](https://Permaweb.io)
- 📖 Docs: [docs.Permaweb.io](https://docs.Permaweb.io)
- 🐦 Twitter: [@Permaweb](https://twitter.com/Permaweb)
- 💬 Discord: [discord.gg/Permaweb](https://discord.gg/Permaweb)
- 📧 Contact: hello@Permaweb.io
